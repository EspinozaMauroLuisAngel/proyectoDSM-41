...
<div class="row">
    ...
    <div class="col-lg-12 mb-4">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
            <form action="<?php echo e(route('listnote.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\angel\Desktop\cuervo\resources\views/listnote/add.blade.php ENDPATH**/ ?>