...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Agregar Una Nota</h1>
</div>
    ...
    <div class="col-lg-12 mb-4">
        ...
        <div class="card shadow mb-4">
            ...
            <form action="<?php echo e(route('note.store')); ?>" method="POST">
                ...
                <input class="form-control" id="validationServer02" type="text" name="description" required>
...
<?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\angel\Desktop\cuervo\resources\views/note/add.blade.php ENDPATH**/ ?>