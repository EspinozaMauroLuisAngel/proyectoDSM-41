...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Agregar Una Nota de Imagen</h1>
</div>
...
<div class="row">
    ...
    <div class="col-lg-12 mb-4">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
            <form action="<?php echo e(route('imagenote.store')); ?>" enctype="multipart/form-data" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\angel\Desktop\Agenda\resources\views/imagenote/add.blade.php ENDPATH**/ ?>